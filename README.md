...
"DatastoreBroadcastEventTypes=True" in the EDR configuration (more on this below). The new recommended multi-threaded
variable setting is "EnableRawSensorDataBroadcast=True", replacing the DatastoreBroadcastEventTypes variable.
